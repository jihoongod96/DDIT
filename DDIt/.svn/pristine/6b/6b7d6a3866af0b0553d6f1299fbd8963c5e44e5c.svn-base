              ...
              <div class="row">
                <div class="col-lg-3" style="margin-left: 50px; margin-top: 50px;">
                  <div class="avatar avatar-5xl shadow-sm img-thumbnail rounded-circle">
                    ...
                    <img src="/atch/${student.atchList[0].streFileName }" width="200" alt="" data-dz-thumbnail="data-dz-thumbnail">
                    </div>
                  </div>
...
<!-- 팔로워 리스트 출력 처리 -->
<script src="${pageContext.request.contextPath }/resources/js/app/sns/snsStudentProfile.js"></script>