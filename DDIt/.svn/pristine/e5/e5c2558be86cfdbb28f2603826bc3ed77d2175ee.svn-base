    ...
    <div class="card">
          ...
          <div class="card mb-3">
                ...
                <div class="card-body pt-0 pt-md-3">
                  <div id="searchUI" class="row g-3 align-items-center">
                    <div class="col">
                      ...
                      <div class="row g-0 g-md-3 justify-content-end">
                        <div class="col-auto">
                          <div class="row gx-2">
                            ...
                            <div class="col-auto">
                              <form:select path="condition.searchType" class="form-select form-select-sm" aria-label="Bulk actions">
                                <form:option value="sj">제목</form:option>
                                <form:option value="user">아이디</form:option>
                              </form:select>
                            </div>
                          </div>
                        </div>
...
<!-- 메세지 리스트 비동기 페이징 -->
<script src="${pageContext.request.contextPath }/resources/js/app/message/messageList.js"></script>