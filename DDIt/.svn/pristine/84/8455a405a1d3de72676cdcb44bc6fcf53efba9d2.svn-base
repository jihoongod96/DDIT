...
<div class="card mb-3">
  ...
  <div class="card-body bg-body-tertiary">
      <div class="row gx-2">
        ...
        <form name="" class="dropzone dropzone-multiple p-0" id="my-awesome-dropzone" data-dropzone="data-dropzone" enctype="multipart/form-data">
			<div class="card-body bg-body-tertiary">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-0a78c878-1945-4cce-963b-63afa16b5841" id="dom-0a78c878-1945-4cce-963b-63afa16b5841">
                  ...
                  <div class="mb-3">
                    ...
                    <textarea class="form-control" name="classTopic" rows="3"></textarea>
                  </div>
                </div>
...
<!-- 			            <div class="dz-progress"><span class="dz-upload" data-dz-uploadprogress=""></span></div> -->
      ...
      <button class="btn btn-falcon-default me-1 mb-1" type="button">추가등록
	  </button>
