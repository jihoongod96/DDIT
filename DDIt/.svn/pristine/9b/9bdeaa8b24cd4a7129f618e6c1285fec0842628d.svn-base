...
<!-- 페이지의 하단에 로딩할 스크립트 관리 -->
    ...
    <script src="${pageContext.request.contextPath}/resources/public/vendors/swiper/swiper-bundle.min.js"> </script>
    <script src="${pageContext.request.contextPath}/resources/public/vendors/typed.js/typed.umd.js"></script>
