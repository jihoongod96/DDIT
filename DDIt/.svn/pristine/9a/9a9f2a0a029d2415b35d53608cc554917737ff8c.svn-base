...
public interface AttenceDAO {
	...
	// 출석중복 확인
	public AttenanceVO selectAttenance(@Param("userId") String userId);
	// 학생 퇴실하기
	...
	// 외출 중복확인
	public List<GoingOutVO> checkGoingOut(@Param("attenanceCode") String attenanceCode);
	// 외출 복귀하기
	...
	// 출결정보 리스트
	public List<AttenanceVO> selectAttenanceList(@Param("userId") String userId);
}
