...
<html data-bs-theme="light" lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <link rel="manifest" href="${pageContext.request.contextPath}/resources/images/manifest.json">
    <meta name="msapplication-TileImage" content="${pageContext.request.contextPath}/resources/images/mstile-150x150.png">
    ...
    <link href="${pageContext.request.contextPath}/resources/css/simplebar.min.css" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/resources/css/theme-rtl.min.css" rel="stylesheet" id="style-rtl">
    <link href="${pageContext.request.contextPath}/resources/css/theme.min.css" rel="stylesheet" id="style-default">
    <link href="${pageContext.request.contextPath}/resources/css/user-rtl.min.css" rel="stylesheet" id="user-style-rtl">
    <link href="${pageContext.request.contextPath}/resources/css/user.min.css" rel="stylesheet" id="user-style-default">
    <script>
  ...
  <body>
    ...
    <script src="${pageContext.request.contextPath}/resources/js/anchor.min.js"></script>
    <script src="${pageContext.request.contextPath}/resources/js/is.min.js"></script>
