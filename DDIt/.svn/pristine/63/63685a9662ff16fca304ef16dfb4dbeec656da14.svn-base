...
<nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
	...
	<ul
		...
		<li class="nav-item d-none d-sm-block"><a
			class="nav-link px-0 notification-indicator-warning notification-indicator-fill fa-icon-wait"
		...
		<li class="nav-item dropdown"><a
			class="nav-link notification-indicator-primary px-0 fa-icon-wait"
