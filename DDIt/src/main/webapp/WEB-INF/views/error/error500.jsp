    ...
    <main class="main" id="top">
      <div class="container" data-layout="container">
        <div class="row flex-center min-vh-100 py-6 text-center">
          <div class="col-sm-10 col-md-8 col-lg-6 col-xxl-5"><a class="d-flex flex-center mb-4" href="${pageContext.request.contextPath}/index.do"><img class="me-2" src="${pageContext.request.contextPath}/resources/images/DDIT1.png" alt="" width="58" /><span class="font-sans-serif text-primary fw-bolder fs-4 d-inline-block">DDIT</span></a>
            <div class="card">
              <div class="card-body p-4 p-sm-5">
                <div class="fw-black lh-1 text-300 fs-error">500</div>
                <p class="lead mt-4 text-800 font-sans-serif fw-semi-bold w-md-75 w-xl-100 mx-auto">"죄송합니다. 서버 오류로 인해 페이지를 표시할 수 없습니다. 곧 다시 시도해주세요."</p>
                <hr />
                <a class="btn btn-primary btn-sm mt-3" href="${pageContext.request.contextPath}/index.do"><span class="fas fa-home me-2"></span>홈으로 돌아가기</a>
              </div>
            </div>
          </div>
        </div>
