            ...
            <div class="card-header" >
              <div class="row align-items-center">
                <div class="col d-flex align-items-center">
                  ...
                  <button onclick="messageChkRestore(this)" class="btn btn-tertiary btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="보관해제">
...
<!-- 메세지 리스트 비동기 페이징 -->
<script src="${pageContext.request.contextPath }/resources/js/app/message/messageImportant.js"></script>